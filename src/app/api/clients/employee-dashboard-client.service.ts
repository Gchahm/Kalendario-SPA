...
import {Appointment, AppointmentAdapter, EmployeeDashboardModel, EmployeeDashboardAdapter} from '@api/models';
...
export class EmployeeDashboardClient extends ModelViewSetClient<Appointment, EmpDashboardParams> {
